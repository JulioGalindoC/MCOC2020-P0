...
#
# DESEMPEÑO scipy.linalg.inv - overwrite_a=True - np.longdouble
############################################################
...
for i in range(num_runs) :
    ...
    dts = []
    mem = []
    name =(f'scipy_linalg_True_longdouble{i}.txt')
    fid = open(name, 'w')
    ...
    for i in N :
        ...
        size = 2 * (i**2) * 48   # 2 Matrices, i^2, 48 bits por cada numero float
